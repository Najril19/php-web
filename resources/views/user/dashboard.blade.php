...
<div class="mx-auto max-w-7xl space-y-8">
    <div>
        <h1 class="text-2xl font-bold tracking-tight text-slate-900 md:text-3xl">Selamat datang, {{ $auth['nama_lengkap'] }}!</h1>
        <p class="mt-1 text-sm text-slate-500">Ringkasan aktivitas diagnosa Anda.</p>
        @if (!empty($dbError))
    ...
    <div class="grid gap-6 lg:grid-cols-2">
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p class="mt-3 text-sm leading-relaxed text-slate-600">
                Pilih gejala yang Anda amati pada kendaraan. Sistem akan mencocokkan dengan basis pengetahuan (relasi gejala–kerusakan) dan menampilkan hasil beserta tingkat kepercayaan.
            </p>
            <div class="mt-6 flex justify-center rounded-2xl bg-slate-50 py-8">
                <i class="bi bi-truck-front text-8xl text-blue-200"></i>
            </div>
        </div>
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
    ...
    <div class="grid gap-6 lg:grid-cols-2">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <h2 class="text-lg font-semibold text-slate-900">Berdasarkan tingkat (kepercayaan)</h2>
