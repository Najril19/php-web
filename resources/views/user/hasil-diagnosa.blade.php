...
<div class="mx-auto max-w-4xl space-y-8">
    ...
    <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm print:border-0 print:shadow-none">
        <div class="border-b border-slate-100 bg-slate-50/80 px-6 py-8 print:bg-white">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-start">
                ...
                <div class="min-w-0 flex-1">
                    <p class="text-xs font-semibold uppercase tracking-wide text-slate-500">Kerusakan teridentifikasi</p>
                    @if ($penyakit)
                        <h1 class="mt-2 text-2xl font-bold leading-tight text-red-600 md:text-3xl">{{ $penyakit->nama_penyakit }}</h1>
                    @else
                        <h1 class="mt-2 text-2xl font-bold text-slate-700">Tidak ada hasil spesifik</h1>
                    @endif
        ...
        <div class="space-y-8 px-6 py-8">
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                ...
                <div class="rounded-2xl border border-amber-200 bg-amber-50/60 p-5">
                    ...
                    <p class="mt-2 text-sm text-amber-900/80">Jika tingkat kerusakan berat atau tidak yakin, hubungi bengkel resmi.</p>
                    <span class="mt-4 inline-flex cursor-default rounded-xl bg-amber-500 px-4 py-2 text-sm font-semibold text-white opacity-90">Hubungi bengkel</span>
                </div>
            </div>
