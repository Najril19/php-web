...
<div class="mx-auto max-w-7xl space-y-8">
    <div>
        <h1 class="text-2xl font-bold tracking-tight text-slate-900 md:text-3xl">Dashboard</h1>
        <p class="mt-1 text-sm text-slate-500">Ringkasan data master dan aktivitas diagnosa.</p>
    </div>
    ...
    <div class="grid gap-6 lg:grid-cols-2">
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <h2 class="text-lg font-semibold text-slate-900">Informasi sistem</h2>
            <p class="mt-3 text-sm leading-relaxed text-slate-600">
                Kelola data kerusakan, gejala, dan relasi IF–THEN untuk forward chaining. Pantau tren diagnosa dan distribusi tingkat kepercayaan dari seluruh pengguna.
            </p>
            <div class="mt-6 flex flex-wrap items-center gap-4 rounded-2xl bg-slate-50 p-5">
                <i class="bi bi-printer text-6xl text-blue-200"></i>
                <div class="min-w-0 flex-1 text-sm text-slate-600">
                    <p><span class="font-semibold text-slate-800">{{ $gejala }}</span> gejala · <span class="font-semibold text-slate-800">{{ $users }}</span> pengguna (role user)</p>
                </div>
            </div>
        </div>
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <h2 class="text-lg font-semibold text-slate-900">Referensi kerusakan</h2>
    ...
    <div class="grid gap-6 lg:grid-cols-2">
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <h2 class="text-lg font-semibold text-slate-900">Statistik diagnosa (7 hari)</h2>
            <p class="text-xs text-slate-500">Seluruh pengguna</p>
            <div class="mt-4 h-64"><canvas id="chartLineAdmin"></canvas></div>
        </div>
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            <h2 class="text-lg font-semibold text-slate-900">Diagnosa berdasarkan tingkat</h2>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <h2 class="text-lg font-semibold text-slate-900">Diagnosa terbaru</h2>
